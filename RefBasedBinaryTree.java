...
public class RefBasedBinaryTree implements BinaryTree {
    ...
    * Returns: int – the sum
    ...
    private int sumRec(TreeNode n) {
        if (n == null) {
            return 0;
        }

        return n.data + sumRec(n.left) + sumRec(n.right);
    }
    ...
    */
    ...
    private boolean findRec(TreeNode n, int val) {
        if (n == null) {
            return false;
        } 
        ...
        return findRec(n.left, val) || findRec(n.right, val);
    }
    ...
    */
    ...
    private int getMaxRec(TreeNode n) {
        if (n == null) {
            return Integer.MIN_VALUE;
        }

        int max = n.data;
        int leftMax = getMaxRec(n.left);
        int rightMax = getMaxRec(n.right);
